...
- pin_list:
  - {pin_num: '62', peripheral: FREQME0, signal: 'IN, 0', pin_signal: P1_4/WUU0_IN8/FREQME_CLK_IN0/LPSPI0_PCS3/LPUART2_RXD/CT1_MAT2/ADC0_A20/CMP0_IN2, slew_rate: fast,
    open_drain: disable, drive_strength: low, pull_select: down, pull_enable: disable, input_buffer: enable, invert_input: normal}
  - {pin_num: '63', peripheral: FREQME0, signal: 'IN, 1', pin_signal: P1_5/FREQME_CLK_IN1/LPSPI0_PCS2/LPUART2_TXD/CT1_MAT3/ADC0_A21/CMP1_IN2, slew_rate: fast, open_drain: disable,
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port1_4_pin62_config = {/* Internal pull-up/down resistor is disabled */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    kPORT_UnlockRegister};
    /* PORT1_4 (pin 62) is configured as FREQME_CLK_IN0 */
    ...
    const port_pin_config_t port1_5_pin63_config = {/* Internal pull-up/down resistor is disabled */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    kPORT_UnlockRegister};
    /* PORT1_5 (pin 63) is configured as FREQME_CLK_IN1 */
