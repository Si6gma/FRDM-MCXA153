...
Resources: *ese_driver_examples\flexpwm\edge_aligned*
...
The MCXA153 has one instance of the FLEXPWM module. It is called PWM0 (or FLEXPWM0). The FLEXPWM is described in the [reference manual chapter 31](./../../../../datasheets/MCXAP64M96FS3RM.pdf#31%20Enhanced%20Flex%20Pulse%20Width%20Modulator%20(eFlexPWM)){:target="_blank"}.

It is called an **(enhanced) flex** PWM module, because it offers a lot of features (see [reference manual paragraph 31.2.2](./../../../../datasheets/MCXAP64M96FS3RM.pdf#31%20Enhanced%20Flex%20Pulse%20Width%20Modulator%20(eFlexPWM)){:target="_blank"}). These features allow for the generation of lots of different PWM signals. However, when there are a lot of features involved, often a lot of configuration option must be set correctly before the module is operational.
...
The [board schematic page 7](./../../../../datasheets/SPF-90829_A1.pdf#page=7){:target="_blank"} shows that the following (FLEX)PWM0 channels are connected to the RGB LED:
...
For the code example above, the following configuration is applicable:
...
![flexpwm0_result](./../../../../imgs/flexpwm0_result.png)
...
![flexpwm0_servo](./../../../../imgs/flexpwm0_servo.png)

*`Q1` What are suitable values for the *prescaler* and *modulo (top)* (given that main_clk = 48 MHz) for generating such a servo PWM signal?*

*`Q2` What match value is equal to a duty cycle of 1 ms?*
